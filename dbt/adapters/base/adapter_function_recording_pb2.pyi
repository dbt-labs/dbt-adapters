...
@typing.final
class RecordingData(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    @typing.final
    class ThreadOperationsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        key: builtins.str
        @property
        def value(self) -> global___ThreadOperations: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: global___ThreadOperations | None = ...,
        ) -> None: ...
    ...
    THREAD_OPERATIONS_FIELD_NUMBER: builtins.int
    @property
    def thread_operations(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___ThreadOperations]:
        """Map of thread_name to Operations"""

    def __init__(
        self,
        *,
        thread_operations: (
            collections.abc.Mapping[builtins.str, global___ThreadOperations] | None
        ) = ...,
    ) -> None: ...
    def ClearField(
        self, field_name: typing.Literal["thread_operations", b"thread_operations"]
    ) -> None: ...

global___RecordingData = RecordingData

@typing.final
class ThreadOperations(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    @typing.final
    class OperationsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
        ...
        key: builtins.str
        @property
        def value(self) -> global___OperationList: ...
        def __init__(
            self,
            *,
            key: builtins.str = ...,
            value: global___OperationList | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["value", b"value"]) -> builtins.bool: ...
        def ClearField(
            self, field_name: typing.Literal["key", b"key", "value", b"value"]
    ...
    def operations(
        self,
    ) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___OperationList]:
        """Map of operation_name to list of Operation"""

    def __init__(
        self,
        *,
        operations: collections.abc.Mapping[builtins.str, global___OperationList] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["operations", b"operations"]) -> None: ...

global___ThreadOperations = ThreadOperations
