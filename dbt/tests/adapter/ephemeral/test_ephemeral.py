...
class BaseEphemeralMulti(BaseEphemeral):
    @pytest.fixture(scope="class")
    def models(self):
        return {
            "dependent.sql": models.dependent_sql,
            "double_dependent.sql": models.double_dependent_sql,
            "super_dependent.sql": models.super_dependent_sql,
            "base": {
                "female_only.sql": models.base__female_only_sql,
                "base.sql": models.base__base_sql,
                "base_copy.sql": models.base__base_copy_sql,
            },
        }
...
class BaseEphemeralNested(BaseEphemeral):
    ...
    def models(self):
        return {
            "ephemeral_level_two.sql": models.n__ephemeral_level_two_sql,
            "root_view.sql": models.n__root_view_sql,
            "ephemeral.sql": models.n__ephemeral_sql,
            "source_table.sql": models.n__source_table_sql,
        }
...
class BaseEphemeralErrorHandling(BaseEphemeral):
    ...
    def models(self):
        return {
            "dependent.sql": models.ephemeral_errors__dependent_sql,
            "base": {
                "base.sql": models.ephemeral_errors__base__base_sql,
                "base_copy.sql": models.ephemeral_errors__base__base_copy_sql,
            },
        }
