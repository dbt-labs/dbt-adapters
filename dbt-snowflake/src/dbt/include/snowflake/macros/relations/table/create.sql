{% macro snowflake__create_table_as(temporary, relation, compiled_code, language='sql') -%}
    ...
    {%- if language == 'sql' -%}
        ...
        {%- elif catalog_relation.catalog_type == 'LOCAL' -%}
            {{ snowflake__create_table_local_sql(relation, compiled_code) }}
...
{% macro snowflake__create_table_local_sql(relation, compiled_code) -%}
{#-
