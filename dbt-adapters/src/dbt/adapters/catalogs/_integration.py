...
class CatalogIntegration(Protocol):
    """
    Represent a catalog integration for a given user config

    This protocol should be implemented by specific catalog integration types in an adapter.
    ...
    def catalog_relation(self, config: RelationConfig) -> CatalogRelation: ...
