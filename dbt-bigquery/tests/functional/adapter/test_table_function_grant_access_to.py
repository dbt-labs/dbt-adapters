...
class TestTableFunctionGrantAccessTo:
    ...
    def _assert_routine_authorized(self, project, unique_schema, routine_name):
        with project.adapter.connection_named("__test_grants"):
            ...
            authorized_routine_names = [
                e.entity_id["routineId"]
                for e in bq_dataset.access_entries
                if e.entity_type == "routine"
            ]
            assert routine_name in authorized_routine_names
